...
func TestNewSupervisor(t *testing.T) {
	Convey("When I try to instantiate a new supervisor ", t, func() {
		...
		Convey("When I provide correct parameters", func() {
			s, err := NewSupervisor(c, e, mode, []string{}, nil, false)
		...
		Convey("When I provide a nil  collector", func() {
			s, err := NewSupervisor(nil, e, mode, []string{}, nil, false)
		...
		Convey("When I provide a nil enforcer", func() {
			s, err := NewSupervisor(c, nil, mode, []string{}, nil, false)
			Convey("I should get an error ", func() {
				So(err, ShouldNotBeNil)
				So(s, ShouldBeNil)
			})
...
func TestSupervise(t *testing.T) {
	...
	Convey("Given a valid supervisor", t, func() {
		...
		s, _ := NewSupervisor(c, e, constants.RemoteContainer, []string{}, nil, false)
		So(s, ShouldNotBeNil)
...
func TestUnsupervise(t *testing.T) {
	...
	Convey("Given a properly configured  supervisor", t, func() {
		...
		s, _ := NewSupervisor(c, e, constants.RemoteContainer, []string{"172.17.0.0/16"}, nil, false)
		So(s, ShouldNotBeNil)
